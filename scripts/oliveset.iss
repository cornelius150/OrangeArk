...
#define MyAppName "OliveSet"
#define MyAppPublisher "Giuseppe Penone"
#define MyAppURL "https://www.giuspen.net/oliveset/"
#define MyAppExeName "oliveset.exe"
#define MyAppVersion GetFileVersion('..\build\oliveset.exe')
...
LicenseFile=..\build\oliveset_{#MyAppVersion}_win64_portable\license.txt
; Uncomment the following line to run in non administrative install mode (install for current user only.)
;PrivilegesRequired=lowest
OutputBaseFilename=oliveset_{#MyAppVersion}_win64_setup
SetupIconFile=..\icons\oliveset.ico
Compression=lzma2
...
[Registry]
Root: HKCR; Subkey: ".ctb"; ValueType: string; ValueName: ""; ValueData: "OliveSetB"; Flags: uninsdeletevalue
Root: HKCR; Subkey: "OliveSetB"; ValueType: string; ValueName: ""; ValueData: "OliveSet SQLite Document"; Flags: uninsdeletekey
Root: HKCR; Subkey: "OliveSetB\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\ucrt64\bin\{#MyAppExeName},0"
Root: HKCR; Subkey: "OliveSetB\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\ucrt64\bin\{#MyAppExeName}"" ""%1"""
Root: HKCR; Subkey: ".ctx"; ValueType: string; ValueName: ""; ValueData: "OliveSetX"; Flags: uninsdeletevalue
Root: HKCR; Subkey: "OliveSetX"; ValueType: string; ValueName: ""; ValueData: "OliveSet SQLite Zipped"; Flags: uninsdeletekey
Root: HKCR; Subkey: "OliveSetX\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\ucrt64\bin\{#MyAppExeName},0"
Root: HKCR; Subkey: "OliveSetX\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\ucrt64\bin\{#MyAppExeName}"" ""%1"""
Root: HKCR; Subkey: ".ctd"; ValueType: string; ValueName: ""; ValueData: "OliveSetD"; Flags: uninsdeletevalue
Root: HKCR; Subkey: "OliveSetD"; ValueType: string; ValueName: ""; ValueData: "OliveSet XML Document"; Flags: uninsdeletekey
Root: HKCR; Subkey: "OliveSetD\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\ucrt64\bin\{#MyAppExeName},0"
Root: HKCR; Subkey: "OliveSetD\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\ucrt64\bin\{#MyAppExeName}"" ""%1"""
Root: HKCR; Subkey: ".ctz"; ValueType: string; ValueName: ""; ValueData: "OliveSetZ"; Flags: uninsdeletevalue
...
[Files]
Source: "..\build\oliveset_{#MyAppVersion}_win64_portable\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
