...
Root: HKCR; Subkey: "OrangeArkB"; ValueType: string; ValueName: ""; ValueData: "OrangeArk SQLite Document"; Flags: uninsdeletekey
Root: HKCR; Subkey: "OrangeArkB\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\ucrt64\bin\{#MyAppExeName},0"
Root: HKCR; Subkey: "OrangeArkB\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\ucrt64\bin\{#MyAppExeName}"" ""%1"""
Root: HKCR; Subkey: ".ctx"; ValueType: string; ValueName: ""; ValueData: "OrangeArkX"; Flags: uninsdeletevalue
Root: HKCR; Subkey: "OrangeArkX"; ValueType: string; ValueName: ""; ValueData: "OrangeArk SQLite Zipped"; Flags: uninsdeletekey
Root: HKCR; Subkey: "OrangeArkX\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\ucrt64\bin\{#MyAppExeName},0"
Root: HKCR; Subkey: "OrangeArkX\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\ucrt64\bin\{#MyAppExeName}"" ""%1"""
Root: HKCR; Subkey: ".ctd"; ValueType: string; ValueName: ""; ValueData: "OrangeArkD"; Flags: uninsdeletevalue
Root: HKCR; Subkey: "OrangeArkD"; ValueType: string; ValueName: ""; ValueData: "OrangeArk XML Document"; Flags: uninsdeletekey
Root: HKCR; Subkey: "OrangeArkD\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\ucrt64\bin\{#MyAppExeName},0"
Root: HKCR; Subkey: "OrangeArkD\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\ucrt64\bin\{#MyAppExeName}"" ""%1"""
Root: HKCR; Subkey: ".ctz"; ValueType: string; ValueName: ""; ValueData: "OrangeArkZ"; Flags: uninsdeletevalue
Root: HKCR; Subkey: "OrangeArkZ"; ValueType: string; ValueName: ""; ValueData: "OrangeArk XML Zipped"; Flags: uninsdeletekey
Root: HKCR; Subkey: "OrangeArkZ\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\ucrt64\bin\{#MyAppExeName},0"
Root: HKCR; Subkey: "OrangeArkZ\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\ucrt64\bin\{#MyAppExeName}"" ""%1"""
Root: HKCR; Subkey: ".md"; ValueType: string; ValueName: ""; ValueData: "OrangeArkMD"; Flags: uninsdeletevalue
